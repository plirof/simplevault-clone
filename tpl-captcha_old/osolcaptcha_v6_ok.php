...
*/
    ...
    function display($code="hello from display12")
		{
	...
	function create_imagePlane($security_code="hello from create image pane")
	{
		...
		for($i=0;$i<strlen($security_code);$i++)
		{
			...
			@imagettftext($image, $size, $angle, $x+10 + (int)($size / 15), $y, $grey,'osolCaptcha/adlibBT.TTF', $security_code[$i]);
